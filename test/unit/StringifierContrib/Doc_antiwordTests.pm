...
sub test_stringForFile {
    my $this = shift;
    my $stringifier1 =
      Foswiki::Contrib::Stringifier::Plugins::DOC_antiword->new();
    my $stringifier2 =
      Foswiki::Contrib::Stringifier::Plugins::DOC_abiword->new();
...
sub test_SpecialCharacters {
    ...
    my $text =
      $stringifier->stringForFile(
        $this->{attachmentDir} . 'Simple_example.doc' );
...
sub test_passwordedFile {
    ...
    my $text =
      $stringifier->stringForFile(
        $this->{attachmentDir} . 'Passworded_example.doc' );
...
sub test_maliciousFile {
    ...
    my $text =
      $stringifier->stringForFile( $this->{attachmentDir} . 'Im_a_png.doc' );
