...
sub test_SpecialCharacters {
    ...
    $this->assert_matches( 'Überflieger', $text,
        "Text Überflieger not found." );
}
...
sub test_maliciousFile {
    ...
    my $text =
      $stringifier->stringForFile( $this->{attachmentDir} . 'Im_a_png.pdf' );
