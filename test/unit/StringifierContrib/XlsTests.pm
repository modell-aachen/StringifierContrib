...
sub test_SpecialCharacters {
    ...
    $text =
      $stringifier->stringForFile(
        $this->{attachmentDir} . 'Portuguese_example.xls' );
...
sub test_passwordedFile {
    ...
    my $text =
      $stringifier->stringForFile(
        $this->{attachmentDir} . 'Passworded_example.xls' );
...
sub test_maliciousFile {
    ...
    my $text =
      $stringifier->stringForFile( $this->{attachmentDir} . 'Im_a_png.xls' );
