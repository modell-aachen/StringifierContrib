...
sub test_SpecialCharacters {
    ...
    $text =
      $stringifier->stringForFile(
        $this->{attachmentDir} . 'Portuguese_example.xlsx' );
...
sub DIStest_passwordedFile {
    ...
    my $text =
      $stringifier->stringForFile(
        $this->{attachmentDir} . 'Passworded_example.xlsx' );
...
sub DIStest_maliciousFile {
    ...
    my $text =
      $stringifier->stringForFile( $this->{attachmentDir} . 'Im_a_png.xlsx' );
