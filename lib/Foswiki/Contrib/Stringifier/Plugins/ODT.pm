...
__PACKAGE__->register_handler( "application/vnd.oasis.opendocument.text",
    ".odt" );
...
__PACKAGE__->register_handler( "application/vnd.oasis.opendocument.spreadsheet",
    "ods" );
__PACKAGE__->register_handler(
    "application/vnd.oasis.opendocument.spreadsheet-template", "ots" );
__PACKAGE__->register_handler( "application/vnd.sun.xml.writer", "sxw" );
__PACKAGE__->register_handler( "application/vnd.sun.xml.writer.template",
    "stw" );
...
__PACKAGE__->register_handler( "application/vnd.sun.xml.impress.template",
    "sti" );
